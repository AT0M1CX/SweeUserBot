...
function install {
    ...
    sleep 0.1
    clear
    echo "${BLUE}[${MAGENTA}*${BLUE}] ${CYAN}Upgrating ${MAGENTA}apt${CYAN} and ${MAGENTA}pkg.."
    echo
    echo
    apt upgrade -y
    pkg upgrade -y
    sleep 1
    clear    
    echo "${BLUE}[${MAGENTA}*${BLUE}] ${CYAN}Updating ${MAGENTA}apt${CYAN} and ${MAGENTA}pkg.."
    echo
    echo
    pkg update -y
    apt update -y
    sleep 1
    clear
    echo "${BLUE}[${MAGENTA}*${BLUE}] ${CYAN}Installing ${BLUE}pyt${ORANGE}hon.."
    echo
    echo
    pkg install python -y
    sleep 1
    clear
    echo "${BLUE}[${MAGENTA}*${BLUE}] ${CYAN}Installing ${MAGENTA}git..${CYAN}"
    echo
    echo
    pkg install git -y
    sleep 1
    clear
    echo "${BLUE}[${MAGENTA}*${BLUE}] ${CYAN}Downloading ${MAGENTA}resource for ${BLUE}Swee${CYAN}User${MAGENTA}Bot${CYAN}.."
    echo
    echo
    git clone https://github.com/AT0M1CX/SweeUserBot/
    sleep 1
    clear
    echo "${BLUE}[${MAGENTA}*${BLUE}] ${CYAN}Installing ${MAGENTA}requirements${CYAN}.."
    echo
    echo
    ...
    sleep 1
    clear
    echo "${BLUE}[${MAGENTA}*${BLUE}] ${CYAN}Installing ${GREEN}Successfully ✅${CYAN}";
    echo
    echo
    echo "1" > SweeUserBot/installed.txt
    echo
    echo
    read -p "${BLUE}[${MAGENTA}*${BLUE}] ${CYAN}Press ${GREEN_BG}${BLACK} Enter ${DEFAULT_BG}${CYAN} To return to the main menu."; 
}
